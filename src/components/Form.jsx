              ...
              <div className="mx-auto w-full max-w-sm lg:w-96">
                <div>
                  ...
                  <p className="mt-2 text-sm text-gray-600">
                    Estos datos tienen una finalidad informativa{" "}
                    <a
                      href="#"
                      className="font-medium text-teal-600 hover:text-teal-500"
                    >
                      y de feedback para siempre ofrecer un mejor servicio.
                    </a>
                  </p>
                </div>
                    ...
                    <form className="space-y-6" action="" onSubmit={handleSubmit}>
                      <div>
                        ...
                        <div className="mt-1">
                          ...
                          >
                            <option value="">Califica nuestro servicio</option>
                            <option value="2">Malo +2</option>
                            <option value="4">Regular +4</option>
                            <option value="6">Mejorable +6</option>
                            <option value="8">Bueno +8</option>
                      ...
                      <div>
                        ...
                        <div className="mt-1">
                          ...
                          >
                            <option value="">
                              Califica nuestra actualizacion
                            </option>
                            <option value="2">Malo +2</option>
                            <option value="4">Regular +4</option>
                            <option value="6">Mejorable +6</option>
