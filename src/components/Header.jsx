    ...
    <div className="relative bg-white overflow-hidden">
              ...
              >
                <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    <a href="#">
                      <span className="sr-only">Iktan Protect</span>
                      <img
                        alt="Iktan Protect"
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">IKTAN PROTECT</span>{" "}
                <span className="block text-teal-600 xl:inline">CONOCENOS</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Broker especializado en el Sector Hidrocarburos.
                <br />
                <br />
                No tenemos compromisos exclusivos con ninguna compañía de
                seguros, lo que nos permite ofrecer a nuestro clientes los
                mejores productos de cada compañía de forma objetiva y
                transparente, siempre buscando la mejor cobertura al menor
                costo.
              </p>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          ...
          src="https://i.imgur.com/ZflVFW8.png"
          alt=""
        />
      </div>
    </div>
